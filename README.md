...
[![Build Status](https://github.com/libs4di/FW4di.Dotnet.MVVM/actions/workflows/dotnet.yml/badge.svg)](https://github.com/libs4di/FW4di.Dotnet.MVVM/actions/workflows/dotnet.yml)
...
-----
```bash
git clone https://github.com/libs4di/FW4di.Dotnet.MVVM.git
```
